...
if os.path.exists(WEIGHTS_PATH):
    ...
    print(f"✅ OCLAST Weights Loaded Successfully: {os.path.basename(WEIGHTS_PATH)}")
...
if os.path.exists(TEST_IMAGE_PATH):
    ...
    fig.suptitle(f"OCLAST Results: {cell_count} Osteoclasts Detected", fontsize=20, fontweight='bold')
